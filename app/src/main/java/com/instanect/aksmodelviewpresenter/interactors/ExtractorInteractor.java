...
public class ExtractorInteractor extends AbstractExtractorInteractor {
    public ExtractorInteractor(ExtractorInterface extractorInterface) {
        super(extractorInterface);
    }
}
